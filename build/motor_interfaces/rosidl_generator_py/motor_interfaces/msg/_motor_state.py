...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.abs_position = kwargs.get('abs_position', float())
    ...
    def __eq__(self, other):
        ...
        if self.position != other.position:
            return False
        if self.abs_position != other.abs_position:
            return False
    ...
    def abs_position(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'abs_position' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'abs_position' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
