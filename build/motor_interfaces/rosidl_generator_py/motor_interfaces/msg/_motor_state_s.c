...
bool motor_interfaces__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // abs_position
    PyObject * field = PyObject_GetAttrString(_pymsg, "abs_position");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->abs_position = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // velocity
...
PyObject * motor_interfaces__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // abs_position
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->abs_position);
    {
      int rc = PyObject_SetAttrString(_pymessage, "abs_position", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
