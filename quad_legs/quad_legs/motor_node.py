...
LIMITS = {
    ...
    "AK40-10":dict(P_MIN=-12.5, P_MAX=12.5, V_MIN=-50.0,  V_MAX=50.0,  T_MIN=-4.0,  T_MAX=4.0,  KP_MIN=0.0, KP_MAX=500.0, KD_MIN=0.0, KD_MAX=5.0),
...
class MotorNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('motor_type', 'AK40-10')     # Motor model
